...
#______________________________________________________________________________
        ax[0].text(15, 25, 'RA: %.5f' % (obj_ra_red[0]), fontsize=12)
        ax[0].text(15, 45, 'Dec: %.5f'% (obj_dec_red[0]), fontsize=12)
        ...
        plt.savefig(outpath + '/'+str(plateifu)+'.pdf', dpi=my_dpi, bbox_inches='tight')
        plt.close('all')
