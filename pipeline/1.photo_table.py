...
reduction pipeline catalog. The script collects all photometric objects within
twice the radius of the IFU. The photometric table build is organized based on
distance from the plate-IFU's target object with the target object being the 
leading object in the table.
"""
print('\nInitializing...\n')
